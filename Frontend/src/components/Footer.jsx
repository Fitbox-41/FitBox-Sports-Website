          ...
          <div className={`footer-col-content ${openFooterCol === 'about' ? 'open' : ''}`}>
            ...
            <div className="footer-socials" id="footer-socials">
              {[
                { 
                  name: 'X', 
                  url: 'https://x.com/search?q=fitbox%20sports&src=recent_search_click', 
                  icon: (
                ...
                { 
                  name: 'Instagram', 
                  url: 'https://www.instagram.com/fitbox.sports?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==', 
                  icon: (
                ...
                { 
                  name: 'Mail', 
                  url: 'mailto:fitboxsports01@gmail.com', 
                  icon: (
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className={`footer-col-content ${openFooterCol === 'shop-links' ? 'open' : ''}`}>
            <ul className="footer-links">
              {[
                ...
                { label: 'Grippers', path: '/category/Grippers'          },
              ].map((l) => (
                <li key={l.label}>
