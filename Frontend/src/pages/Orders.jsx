              ...
              return (
                <div key={idx} className="orders-list-item">
                  ...
                  <div className="orders-actions-col">
                    ...
                    >
                      <svg viewBox="0 0 24 24" fill={inWishlist ? '#ff416c' : 'none'} stroke={inWishlist ? '#ff416c' : 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="16" height="16">
