        ...
        <div className="info-card">
          ...
          <div className="info-body">
            ...
            <ul>
              ...
              <li><strong>Earning.</strong> Points are earned in two ways in the FitBox app. Every run you save earns points for the distance covered. Separately, a weekly competition runs Monday to Monday (UTC): when it closes, players are ranked by how much new territory they claimed during that week and only the <strong>top 20</strong> receive a prize, the highest rank receiving the largest award and the remainder scaled by rank and area. Points are credited for genuine in-app activity only — we do not sync or reward activity from third-party services such as Apple Health or Google Health Connect, and activity recorded at a speed that is not plausibly running may not be rewarded.</li>
              <li><strong>Expiry.</strong> Points expire <strong>99 days</strong> after the day they are earned. Points are spent oldest first, so those closest to expiring are always used before newer ones. Expired points are removed automatically and cannot be restored.</li>
